...
[role="row"]:has(a[href*="/track/${trackId}"]):not([class*="queue"]):not([class*="Queue"]) {
	background: rgba(126, 251, 238, 0.20) !important;
	box-shadow: inset 3px 0 0 rgb(126, 251, 238) !important;
}
[aria-rowindex]:has(a[href*="/track/${trackId}"]) {
	background: rgba(126, 251, 238, 0.20) !important;
	box-shadow: inset 3px 0 0 rgb(126, 251, 238) !important;
}
[data-track-id="${trackId}"] { background: rgba(126, 251, 238, 0.20) !important; }
[data-item-id="${trackId}"] { background: rgba(126, 251, 238, 0.20) !important; }
...
[role="row"]:has(a[href*="/track/${trackId}"]) p { color: rgb(126, 251, 238) !important; }
...
[aria-rowindex]:has(a[href*="/track/${trackId}"]) p { color: rgb(126, 251, 238) !important; }
`;
}
